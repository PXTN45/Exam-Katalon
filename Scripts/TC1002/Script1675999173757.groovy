...
WebUI.setText(findTestObject('Object Repository/Page_Demo Site  Registration Form  NxtGen A_68ffcd/input__vfb-5'), 'นัทธพงศ์')

WebUI.setText(findTestObject('Object Repository/Page_Demo Site  Registration Form  NxtGen A_68ffcd/input__vfb-7'), 'ศรีเผ่าพันธุ์')
...
WebUI.setText(findTestObject('Page_Demo Site  Registration Form  NxtGen A_68ffcd/input__vfb-14'), 'patnattapong123@gmail.com')
...
WebUI.setText(findTestObject('Page_Demo Site  Registration Form  NxtGen A_68ffcd/input__vfb-3'), 'asd')
...
WebUI.click(findTestObject('Object Repository/Page_Demo Site  Dynamic Transaction  NxtGen_9cd37f/div_Dynamic Transaction Verificationfunctio_bf089f'))
